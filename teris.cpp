...
//   clrscr();
   cleardevice();
   if(y=='1') {spd=200; settextstyle(2,0,6);outtextxy(2,150,"   BasicLevel ");
   break;
   }
   if(y=='2')
    {
        spd=150; settextstyle(2,0,6);outtextxy(2,150,"   MiddleLevel ");
        break;
   }
   if(y=='3') {spd=100; settextstyle(2,0,6);outtextxy(2,150,"  AdvancedLevel ");
   break;
   }
   if(y=='4') {spd=75; settextstyle(2,0,6);outtextxy(2,150,"  ExpertsLevel ");
   break;
   }
   if(y=='5') {spd=50;  settextstyle(2,0,6);outtextxy(2,150,"ProfessionalLevel ");
   break;
   }
      }
      while(1);
...
if(kbhit()){ ch=getch();
		      if(ch==0) ch=getch();
		    if(ch==77) {move=check1(); if(move==0) {l[0]+=15;l[2]+=15;l[4]+=15;k=1;}}
		    if(ch==75) {move=check2(); if(move==0) {l[0]-=15;l[2]-=15;l[4]-=15;k=1;}}
		    if(ch==80) spd=10;
		    if(ch==27) exit(0);
...
l[0]=270;l[2]=285;l[4]=271;break;
	 		 		  case 2:  if(a==1) a--; else p--; l[0]=270;l[2]=285;l[4]=271;
		 		        ...
		 		        if(p==3)  { if(a==0) a++; else a=0;l[0]=270;l[2]=285;l[4]=271; }
